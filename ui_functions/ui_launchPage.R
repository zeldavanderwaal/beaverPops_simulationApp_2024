...
launchPage_ui_txt <-
 tabsetPanel(id ="show_launchPage_tab",  type = "tabs", 
       ...
       div(leaflet::leafletOutput("mapUK_init" , height="96vh", width="99vw" ), style="position:fixed;padding:0;margin:0;border:0;border-radius:0 0 0 51px;overflow:hidden;", class="animate__animated animate__fadeIn animate__slower" ),
...
tags$div(id="div_startW",           absolutePanel(id = "txt_startW", class="animate__animated animate__slideInLeft" ,
                                    ...
                                    fixed = TRUE, style = 'z-index:5;border:0;padding: 6px;z-index:0,position: fixed;background-color:transparent;',
            ...
            absolutePanel(id = "txt_start", 
                                    class = "panel panel-default", #class="animate__animated animate__fadeIn" , 
...
#)),
 ...
 absolutePanel(id ="howtos", style="position: fixed;display: block;color: black;min-width:40vw;width: fit-content;", top="26vh",left="4vw",width="auto",height="55vh",  
 ...
 div("design an operation")), 
              ...
              absolutePanel(id = "txt_div_loadingHowto1b", class = "panel panel-default",#class="animate__animated animate__flipX animate__delay-1s ",  
...
div("> select between two operation types depending on the beaver population to be simulated", style="padding-left: 132px;min-width: 330px;" ), 

div(span(style="font-style: italic;","for instance.."),style="font-size: 90%;display: inline-flex;flex-direction: column;width: -webkit-fill-available;padding-left: 3vw;",
...
hidden( 
 ...
 div("consider the landscape")),
             ...
             absolutePanel(id = "txt_div_loadingHowto2b", class = "panel panel-default",#class="animate__animated animate__flipX animate__delay-1s",  
                   ...
                   draggable =FALSE,  top ="auto", right = "auto", left ="auto", bottom = "auto", width = "40vw", height = "auto", 
div("> create management scenarios and add expert knowledge directly onto the map", style="padding-left: 132px;     min-width: 330px;" ), 
...
div("let the population grow")) ,
             ...
             absolutePanel(id = "txt_div_loadingHowto3b", class = "panel panel-default",#class="animate__animated animate__flipX animate__delay-1s",  
...
div("> simulate population growth in similar starting conditions for a number of repetitions", style="padding-left:132px;min-width:330px;" )  ,
...
hidden( 
 ...
 div("assess potential outcomes")) ,
             ...
             absolutePanel(id = "txt_div_loadingHowto4b", class = "panel panel-default",#class="animate__animated animate__flipX animate__delay-1s",  
                   ...
                   draggable =FALSE,  top ="auto", right = "auto", left ="auto", bottom = "auto", width ="40vw", height = "auto", 
div("> assess trends to gain insight on the potential outcomes of a management action", style="padding-left:132px;min-width:330px;" ) ,
...
###################################################################################################################  end init panel on app starting  
 ...
 tags$div(id="div_steps2",  class="animate__animated animate__fadeInLeft animate__delay-4s",  
        div("..refer to the 'about' tab in-app for more instructions",style="font-weight:600;padding: 46vh 0 0 20vw;") 
))
       ,   
  
 
  tags$div( id="div_loadingLogos",      
    absolutePanel(id = "txt_loadingLogos",  class = "panel panel-default", class="animate__animated animate__fadeIn animate__slower",
 ...
 hidden(
  tags$div(id="div_txt_prog", 
             absolutePanel(id = "txt_start2",   class = "panel panel-default", #class="animate__animated animate__hinge animate__delay-5s",# help panel expl
...
hidden( 
     tags$div(id="launchP_selcntry",      
             absolutePanel(id = "txt_start_selcntry", class = "panel panel-default",class="animate__animated animate__bounce animate__delay-4s",  
                   ...
                   draggable =FALSE,  top =150, right = "9vw", left ="auto", bottom = "auto", width = "25vh", height = "25vh",
